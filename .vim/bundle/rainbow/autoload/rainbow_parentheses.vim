...
function rainbow_parentheses#Activate()
    highlight default level1c   ctermfg=red
    ...
    highlight default level9c   ctermfg=DarkCyan
    highlight default level10c  ctermfg=white
    highlight default level11c  ctermfg=darkmagenta
    highlight default level12c  ctermfg=Darkblue
    highlight default level13c  ctermfg=green
    highlight default level14c  ctermfg=cyan
    highlight default level15c  ctermfg=darkred
    highlight default level16c  ctermfg=yellow
...
function rainbow_parentheses#Clear()
    ...
    endwhile
    let g:rainbow_parenthesis_active = 0
endfunction

function rainbow_parentheses#Toggle ()
    if ! exists('g:rainbow_parenthesis_active')
    ...
    if g:rainbow_parenthesis_active != 0
